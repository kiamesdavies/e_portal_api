...
public class LesserEqualBuilder {
	...
	if (OperatorEnum.getEnum(rule.getOp()) == OperatorEnum.LESSER_EQUAL) {
		...
		return JunctionBuilder.getBuilder(path.loe(rule.getData()), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.loe(Integer.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.loe(Long.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.loe(Double.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.loe(dt), builder, rule);
	    }
