...
public class GreaterEqualBuilder {
	...
	if (OperatorEnum.getEnum(rule.getOp()) == OperatorEnum.GREATER_EQUAL) {
		...
		return JunctionBuilder.getBuilder(path.goe(rule.getData()), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.goe(Integer.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.goe(Long.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.goe(Double.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.goe(dt), builder, rule);
	    }
