...
public class LessThanBuilder {
	...
	if (OperatorEnum.getEnum(rule.getOp()) == OperatorEnum.LESS_THAN) {
		...
		return JunctionBuilder.getBuilder(path.lt(rule.getData()), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.lt(Integer.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.lt(Long.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.lt(Double.valueOf(rule.getData())), builder, rule);
	    }
		...
		return JunctionBuilder.getBuilder(path.lt(dt), builder, rule);
	    }
