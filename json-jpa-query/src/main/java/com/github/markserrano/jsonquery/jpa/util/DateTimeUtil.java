...
public class DateTimeUtil {
    ...
    public static SimpleDateFormat SIMPLE_DATE_WITH_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS");
    public static SimpleDateFormat SIMPLE_DATE_FORMAT = SIMPLE_DATE_WITH_TIME_FORMAT;
